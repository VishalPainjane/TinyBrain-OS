...
| E2E inference not enforced on merge | Low | High | **Mitigated (STAB-001):** merge-blocking integration jobs with SHA256 gate + skip guards; **STAB-002:** timing history + failure phase in `ci-run-record` artifacts |
---
**Layer:** planning
